...
class WhiteNoiseMiddleware(WhiteNoise):
    ...
    def process_request(self, request):
        ...
        if self.autorefresh:
            ...
            print(request.path_info.startswith(self.static_prefix))
            print(request.path_info)
            print(self.static_prefix)
            static_file = self.files.get(request.path_info) if request.path_info.startswith(self.static_prefix) else None
